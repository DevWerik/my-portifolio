                ...
                <div className="md:w-1/2 md:pr-8 mt-6 md:mt-0">
                  ...
                  <div className="bg-slate-700 p-6 rounded-lg shadow-lg hover:scale-105 transition-transform duration-300">
                    ...
                    <p className="text-gray-300 text-justify">
                      ...
                      autenticação completa e intuitiva. Criei as telas de login
                      e cadastro com foco na usabilidade, implementando uma
                      validação de dados robusta e em tempo real para guiar o
                      usuário e garantir a segurança e a confirmação do
                      registro. A base tecnológica foi construída com React e
